                    ...
                    <tr>
                        ...
                        <td>
                            <form id="" class="" method="POST" action="">
                                <input id="qualificar-{$projetos_por_turma[projetos].id_projeto}" name="qualificar_value" type="number" class="rating"  data-show-clear="false" min = "0.1" max="10" step="0.1" data-size="sm"  data-stars=10  value="{$projetos_por_turma[projetos].valor_qualificacao}" {$projetos_por_turma[projetos].status_qualificacao}>
